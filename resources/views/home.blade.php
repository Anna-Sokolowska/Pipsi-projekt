...
@section('content')
 <div class="container mx-auto bg-light mt-3 p-5 rounded-3">
    <h2>{{ __('Last watched movies:') }}</h2>
    @if($watchedMovies->isEmpty())
        <span class="text-muted">{{ __("You haven't watched any movies yet") }}</span>
    @endif
     <div id="watched-movie" class="d-flex flex-wrap gap-5 p-4">
         ...
         <h2>{{ __('10 Most Popular Movie:') }}</h2>
                     ...
                     <div class="card border-0 bg-transparent movie-card" style="width: 12rem;">
                         <div class="card-body p-0">
                             ...
                             <form action="/addMovie" method="post">
                                 ...
                                 <button type="submit" name="add" id="add" class="btn btn-primary" >{{ __('Add') }}</button>
                             </form>
